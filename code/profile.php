...
<head>
  ...
  <!-- bootstrap theme -->
  <link href="profile/css/bootstrap-theme.css" rel="stylesheet">
  <!--external css-->
  <!-- font icon -->
  <link href="profile/css/elegant-icons-style.css" rel="stylesheet" />
  <link href="profile/css/font-awesome.min.css" rel="stylesheet" />
  <!-- Custom styles -->
  <link href="profile/css/style.css" rel="stylesheet">
  <link href="profile/css/style-responsive.css" rel="stylesheet" />
...
<body>
  ...
  <!-- javascripts -->
  <script src="profile/js/jquery.js"></script>
  <script src="profile/js/bootstrap.min.js"></script>
  <!-- nice scroll -->
  <script src="profile/js/jquery.scrollTo.min.js"></script>
  <script src="profile/js/jquery.nicescroll.js" type="text/javascript"></script>
  <!-- jquery knob -->
  <script src="profile/assets/jquery-knob/js/jquery.knob.js"></script>
